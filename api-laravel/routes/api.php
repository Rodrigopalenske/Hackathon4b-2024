...
Route::middleware(['auth:sanctum', 'api'])->group(function () {
    ...
    Route::get('/ambiente', [AmbienteController::class, 'index'])->name('ambiente.index');
    Route::get('/dia-indisponivel/{id}', [DiaIndisponivel::class, 'index'])->name('diaIndisponivel.index');
